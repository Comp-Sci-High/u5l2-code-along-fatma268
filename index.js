...
// create a route handler for /g12 that returns every student in grade 12
...
// create a route handler for /me that returns yourself without using your name

 app.get("/me", async (req,res) => {
const me = await Student.findOne({name: "Fatma Diagne"})
res.json(me)
})

// create a route handler for /friend that returns someone at your table using their name
